...
# Mapeamento dos sensores esperados
SENSORS = {
    ...
    "voltageAC0": {"name": "Tensão AC0", "unit": ELECTRIC_POTENTIAL_VOLT, "icon": "mdi:flash"}
}
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    # Captura todos os dispositivos que publicam no tópico "easymonitor/{deviceID}/#"
    async def device_discovered(msg):
        ...
        if sensor_id in SENSORS:
            entities.append(EasyMonitorSensor(mqtt, device_id, sensor_id))
